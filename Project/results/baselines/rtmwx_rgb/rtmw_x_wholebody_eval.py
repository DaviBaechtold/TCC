...
load_from = 'checkpoints/rtmw-x_simcc-cocktail14_pt-ucoco_270e-384x288-f840f204_20231122.pth'
...
test_evaluator = dict(
    ann_file='data/raw/annotations/coco_wholebody_val_v1.0.json',
...
work_dir = 'results/baselines/rtmwx_rgb'
